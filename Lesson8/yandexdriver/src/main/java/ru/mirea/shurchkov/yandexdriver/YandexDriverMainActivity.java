...
import ru.mirea.shurchkov.yandexdriver.databinding.ActivityYandexDriverMainBinding;
public class YandexDriverMainActivity extends AppCompatActivity implements DrivingSession.DrivingRouteListener {
    private ActivityYandexDriverMainBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityYandexDriverMainBinding.inflate(getLayoutInflater());
        ...
        PlacemarkMapObject marker = mapView.getMap().getMapObjects().addPlacemark(new
                Point(55.751574, 37.573856), ImageProvider.fromResource(this, R.drawable.icon));
