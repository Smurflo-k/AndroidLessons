package ru.mirea.shurchkov.simplefragmentapp;
...
public class SimpleFragmentAppMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simple_fragment_app_main);
