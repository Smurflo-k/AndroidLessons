...
public class YandexMapsMainActivity extends AppCompatActivity implements UserLocationObjectListener {
    ...
    public void onObjectAdded(@NonNull UserLocationView userLocationView) {
        ...
        pinIcon.setIcon(
                "pin",
                ImageProvider.fromResource(this, R.drawable.search_icon),
